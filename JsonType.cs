...
public class JsonType
{
        ...
        : this(generator)
    {
        ...
        if (Type == JsonTypeEnum.Array)
        {
            ...
            InternalType = GetCommonType(generator, array);
        }
    }
    ...
    public static JsonType GetCommonType(IJsonClassGeneratorConfig generator, JArray tokens)
    {
        if (tokens.Count == 0) return new JsonType(generator, JsonTypeEnum.NonConstrained);
